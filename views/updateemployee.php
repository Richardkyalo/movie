...
<body class="main">
    ...
    include("../includes/employeeupdate.inc.php");
    $data = new theatres();
    ...
    $employeedata1= $employeedata->getAllEmployeeDetails($employee);
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 mt-5">
                <form class="row g-3 form" action="" method="POST">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        ...
                        <input type="text" class="form-control" name="role" placeholder="Employee" value="<?php echo $employeedata1['roles']?>" readonly style="color: black;">
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <label for="firstname" class="form-label shadow-sm">First Name</label>
                        <input type="text" class="form-control" name="firstname" placeholder="First Name" value="<?php echo $employeedata1['firstname']?>">
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <label for="inputAddress" class="form-label shadow-sm">Email</label>
                        <input type="text" class="form-control" name="email" placeholder="Email" value="<?php echo $employeedata1['email']?>">
                    </div>
                    <!-- <div class="col-lg-4 col-md-4 col-sm-12">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        ...
                        <input type="text" class="form-control" name="phone" placeholder="Phone" value="<?php echo $employeedata1['phone']?>">
                    </div>
